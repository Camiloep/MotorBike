...
using MotorBike.Models.ViewModels;
...
namespace MotorBike.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public ComprasController(MotorBikeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewData["Precio"] = new SelectList(_context.Repuestos, "Precio", "Precio");
        ...
        public IActionResult Index([FromBody] CompraVM oCompraVM)
        {
            ...
            oCompra.CompraXRepuestos = oCompraVM.oCompraXRepuesto;
        ...
        public async Task<IActionResult> Create([Bind("IdCompra,FechaCompra,Total")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCompra,FechaCompra,Total")] Compra compra)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MotorBikeContext.Compras'  is null.");
            }
            var compra = await _context.Compras.FindAsync(id);
            if (compra != null)
            {
